...
public class Jobs3 extends Thread
{
    //Private variables
    ...
    private final Printer3 printer;  //Variable to store the printer

    //A constructor for the jobs class
    public Jobs3(char jobType, String jobNo, int pages, final Printer3 p)
    {
        this.jobNo = jobNo;
        this.pages = pages;
